...
//           {/* Blog Card 1 */}
//           <div className="bg-black border border-gray-800 rounded-lg overflow-hidden shadow-md ">
//             <Image
...
//                 <i className="text-yellow-400 fas fa-share-alt"></i>
//                 <i className="text-yellow-400 fas fa-heart"></i>
//               </div>
//             </div>
//           </div>
